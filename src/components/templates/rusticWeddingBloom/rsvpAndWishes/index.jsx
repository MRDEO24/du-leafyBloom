  ...
  return (
    ...
    >
      ...
      <RadioGroup onChange={setAttend} value={attend} my="1rem">
        <Stack direction="row">
          <Radio value="true" colorScheme="greenFlow">
            Hadir / Attend
          </Radio>
          <Radio value="false" colorScheme="greenFlow">
      ...
      <MotionHeading
        ...
        textAlign="left"
      >
        {wishesData.filter((wish) => wish.is_showed == true).length >
        dataWishes.filter((wish) => wish.is_showed == true).length
          ? wishesData.filter((wish) => wish.is_showed == true).length
          : dataWishes.filter((wish) => wish.is_showed == true).length}{' '}
        Ucapan / Wishes
      </MotionHeading>
